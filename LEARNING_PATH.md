...
初心者向けの段階的な学習教材です。15ステップでじゃんけんバトルゲームを完成させます。
...
document.querySelector()でHTML要素を取得する方法を学びます。
...
**フォルダ:** `step01a1_get_elements/`

[📚 学習パスに戻る](#-学習ステップ) | [🚀 課題を見る](step01a1_get_elements/README.md)
...
addEventListener()でクリックイベントを設定する方法を学びます。
...
**フォルダ:** `step01a2_click_event/`

[📚 学習パスに戻る](#-学習ステップ) | [🚀 課題を見る](step01a2_click_event/README.md)
...
textContentで画面に表示する方法を学び、じゃんけんボタンを完成させます。
...
**フォルダ:** `step01a3_display_result/`

[📚 学習パスに戻る](#-学習ステップ) | [🚀 課題を見る](step01a3_display_result/README.md)
...
**さあ、Step 01A-1 から始めましょう！ 🚀**

`cd step01a1_get_elements` → `README.md` を開く
